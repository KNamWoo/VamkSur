...
/// <summary>
/// 플레이어 캐릭터의 이동, 스프린트, 애니메이션을 담당하는 스크립트.
/// Unity Input System을 활용하여 키보드/게임패드 입력을 받고,
/// Rigidbody2D를 통해 물리 기반 이동을 처리한다.
/// </summary>
public class Player : MonoBehaviour
{
    ...
    /// </summary>
    /// <param name="value">Input System이 전달하는 이동 입력값 (방향 벡터)</param>
    ...
    /// </summary>
    /// <param name="value">Input System이 전달하는 스프린트 입력값 (미사용)</param>
